    ...
    public void menu() {
        while (true) {
            ...
            if (choice == 1) {
                ...
                for (Car car : cars) {
                    if (car.isAvailable()) {
                        System.out.println(car.getId() + " - "+ car.getColor() + " " + car.getBrand() + " " + car.getModel());
                    }
                }
                ...
                if(selectedCar != null){
                    double totalPrice=selectedCar.calcPrice(rentalDays);
                    System.out.println("\n== Rental Information ==\n");
                    System.out.println("Customer ID: " + newCustomer.getCustomerId());
                    System.out.println("Customer Name: " + newCustomer.getName());
                    System.out.println("Car: "+ selectedCar.getColor()+ " " + selectedCar.getBrand() + " " + selectedCar.getModel());
